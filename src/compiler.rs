...
impl Compiler {
    fn compile(&self, module: &ast::Module) -> ir::Module {
    ...
    fn func_type(&self, function: &ast::Function) -> ir::FuncType {
        let params = function
            .params
            .iter()
    ...
    fn function(&self, ty: ir::TypeIdx, function: &ast::Function) -> ir::Function {
    ...
    fn func_export(&self, func_idx: ir::FuncIdx, func: &ast::Function) -> ir::Export {
        ir::Export {
...
impl ast::TypeKind {
    fn lower(&self) -> ir::ValType {
        match self {
            ast::TypeKind::Int => ir::ValType::I64,
            ast::TypeKind::Float => ir::ValType::F64,
            ast::TypeKind::Bool => todo!("Implement bool type"),
        }
    }
}

pub fn compile(module: &ast::Module) -> ir::Module {
